...
<p align="center">
  <b>Aplikace, která si pamatuje, kdo komu dluží — aby to nemuselo dělat vaše přátelství.</b><br>
  <sub>„Vrátím ti to příští týden" — řečeno v roce 2019. My si to pořád pamatujeme.</sub>
</p>
...
<p align="center">
  <img alt="Platformy" src="https://img.shields.io/badge/Android%20·%20iOS%20·%20Desktop%20·%20Web-6C4DF6?style=for-the-badge">
  <img alt="Offline" src="https://img.shields.io/badge/Nejdřív%20offline-2ecc71?style=for-the-badge">
  <img alt="Bez reklam" src="https://img.shields.io/badge/Bez%20reklam%20·%20bez%20trackerů%20·%20bez%20analytiky-e74c3c?style=for-the-badge">
  <img alt="Jazyky" src="https://img.shields.io/badge/10%20jazyků-f39c12?style=for-the-badge">
</p>
...
```mermaid
flowchart LR
    A[Někdo ti dluží<br/>peníze] --> B[Přidej záznam<br/>za 5 sekund]
    B --> C[Zapisuj splátky<br/>jak přicházejí]
    C --> D[Zůstatek vždy sedí<br/>— sám od sebe]
```
...
| Kde | Odkaz |
|---|---|
| 🌐 **Web** — není co instalovat (účet zdarma) | <b><a href="https://bobadronov.github.io/debt-tracker/" target="_blank" rel="noopener noreferrer">bobadronov.github.io/debt-tracker</a></b> |
...
| 🖥️ **Windows** (MSI) | <a href="https://github.com/bobadronov/debt-tracker/releases/latest" target="_blank" rel="noopener noreferrer">Nejnovější verze</a> |
| 🐧 **Linux** (DEB) | <a href="https://github.com/bobadronov/debt-tracker/releases/latest" target="_blank" rel="noopener noreferrer">Nejnovější verze</a> |
| 🍎 **macOS** (DMG, Intel + Apple Silicon) | <a href="https://github.com/bobadronov/debt-tracker/releases/latest" target="_blank" rel="noopener noreferrer">Nejnovější verze</a> |
