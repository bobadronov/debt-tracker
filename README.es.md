<p align="center">
  <img src="https://bobadronov.github.io/debt-tracker/android-chrome-512x512.png" width="120" alt="Logo de DebtTracker">
</p>

<h1 align="center">DebtTracker</h1>

<p align="center">
  <b>La app que recuerda quién le debe a quién — para que tus amistades no tengan que hacerlo.</b><br>
  <sub>«Te lo devuelvo la semana que viene» — dicho en 2019. Nosotros aún lo recordamos.</sub>
</p>
...
<p align="center">
  ...
  <img alt="Sin conexión" src="https://img.shields.io/badge/Offline%20primero-2ecc71?style=for-the-badge">
  <img alt="Sin anuncios" src="https://img.shields.io/badge/Sin%20anuncios%20·%20sin%20rastreadores%20·%20sin%20analíticas-e74c3c?style=for-the-badge">
...
```mermaid
flowchart LR
    A[Alguien te debe<br/>dinero] --> B[Añade un registro<br/>en 5 segundos]
    B --> C[Anota las devoluciones<br/>según pasan]
    C --> D[El saldo siempre<br/>cuadra — solo]
```
...
| Dónde | Enlace |
|---|---|
| 🌐 **Web** — nada que instalar (cuenta gratuita) | <b><a href="https://bobadronov.github.io/debt-tracker/" target="_blank" rel="noopener noreferrer">bobadronov.github.io/debt-tracker</a></b> |
...
| 🖥️ **Windows** (MSI) | <a href="https://github.com/bobadronov/debt-tracker/releases/latest" target="_blank" rel="noopener noreferrer">Última versión</a> |
| 🐧 **Linux** (DEB) | <a href="https://github.com/bobadronov/debt-tracker/releases/latest" target="_blank" rel="noopener noreferrer">Última versión</a> |
| 🍎 **macOS** (DMG, Intel + Apple Silicon) | <a href="https://github.com/bobadronov/debt-tracker/releases/latest" target="_blank" rel="noopener noreferrer">Última versión</a> |
