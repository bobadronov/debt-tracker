...
/**
 * Pure-Kotlin SHA-256 (FIPS 180-4). Deliberately not `expect`/`actual` onto a platform digest —
 * [PinHasher] needs it in `commonMain`, and there's no single API shared by JVM's
 * `java.security.MessageDigest`, iOS's CryptoKit and the Web targets.
 */
