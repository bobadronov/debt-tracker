 ...
 * WebAuthn option/response JSON is passed straight through — the relying on party is Supabase Auth
...
interface RestoreCredentialClient {
     ...
     * @return the registration-response JSON to hand back to the relying on party.
     */
