    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                OutlinedTextField(
                    value = state.phone,
                    onValueChange = { viewModel.onIntent(AddEditDebtorIntent.PhoneChanged(sanitizePhoneInput(it))) },
                ...
                ClipboardPasteHint(
                    ...
                    onPaste = { viewModel.onIntent(AddEditDebtorIntent.PhoneChanged(sanitizePhoneInput(it))) },
                )
