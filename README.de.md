...
<p align="center">
  <b>Die App, die sich merkt, wer wem was schuldet — damit deine Freundschaften es nicht müssen.</b><br>
  <sub>„Ich zahl's dir nächste Woche zurück" — gesagt 2019. Wir erinnern uns noch.</sub>
</p>
...
<p align="center">
  <img alt="Plattformen" src="https://img.shields.io/badge/Android%20·%20iOS%20·%20Desktop%20·%20Web-6C4DF6?style=for-the-badge">
  <img alt="Offline" src="https://img.shields.io/badge/Offline%20zuerst-2ecc71?style=for-the-badge">
  <img alt="Keine Werbung" src="https://img.shields.io/badge/Keine%20Werbung%20·%20kein%20Tracking%20·%20keine%20Analytics-e74c3c?style=for-the-badge">
  <img alt="Sprachen" src="https://img.shields.io/badge/10%20Sprachen-f39c12?style=for-the-badge">
</p>
...
```mermaid
flowchart LR
    A[Jemand schuldet<br/>dir Geld] --> B[Eintrag anlegen<br/>in 5 Sekunden]
    B --> C[Rückzahlungen erfassen<br/>sobald sie passieren]
    C --> D[Saldo stimmt immer<br/>— automatisch]
```
...
| 🍎 **macOS** (DMG, Intel + Apple Silicon) | [Neuestes Release](https://github.com/bobadronov/debt-tracker/releases/latest) |
